      ...
      >
        ...
        <div
          style={{
            ...
            height: 520,
            borderRadius: "50%",
            background: "radial-gradient(circle, rgba(167,139,250,.16) 0%, transparent 65%)",
          }}
        />

        {/* Glow — zelený, top-right (třetí světlo) */}
        <div
          style={{
            position: "absolute",
            top: -60,
